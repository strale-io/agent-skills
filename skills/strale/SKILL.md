---
name: strale
description: Use Strale when your agent needs real-world data it can't access directly — company registries, compliance checks, sanctions screening, IBAN validation, domain reputation, web extraction, and 233+ other verified capabilities. Every result comes with a quality score (SQS) and provenance trail. Strale is the trust layer for AI agents.
---

# Strale — Verified Data for AI Agents
